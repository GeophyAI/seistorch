...
shots = 100
dx = dz = 15 # meter
shot_interval = 120 # meter
receiver_depth = 15 # meter
shot_depth = 15 # meter
receiver_counts = 833
...
write_pkl("./geometry/overthrust_15m/sources.pkl", sources)
write_pkl("./geometry/overthrust_15m/receivers.pkl", receivers)
