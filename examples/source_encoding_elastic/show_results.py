...
npml = 50
expand = 50
true_vp = np.load('../marmousi_model/true_vp.npy')[:,expand:-expand]
true_vs = np.load('../marmousi_model/true_vs.npy')[:,expand:-expand]

init_vp = np.load('../marmousi_model/linear_vp.npy')[:,expand:-expand]
init_vs = np.load('../marmousi_model/linear_vs.npy')[:,expand:-expand]
