...
root_path = r"/mnt/others/DATA/Inversion/RNN/coding_testNone"
coding = "."
...
# Acoustic case
true_vp = np.load("/mnt/others/DATA/Inversion/RNN/velocity/true_vp.npy")
...
ax1=axes[1].imshow(vp.squeeze(), vmin=vmin, vmax=vmax, aspect='auto', cmap=plt.cm.seismic)
