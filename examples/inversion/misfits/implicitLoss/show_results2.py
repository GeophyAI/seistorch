...
cg_invs = glob.glob("./results_ip*")
sd_invs = glob.glob("./results_l2*")
...
inverted_cg = np.load(f'./results_l2/paravpF{F:02d}E{E:02d}.npy')[npml:-npml, npml+expand:-npml-expand]
inverted_sd = np.load(f'./results_ip/paravpF{F:02d}E{E:02d}.npy')[npml:-npml, npml+expand:-npml-expand]
