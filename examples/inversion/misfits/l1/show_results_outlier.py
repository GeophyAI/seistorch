...
l2 = torch.load('./results/l2_outlier/model_F04E49.pt')['vp'].cpu().detach()[npml:-npml, npml+expand:-npml-expand]
l1 = torch.load('./results/l1_outlier/model_F04E49.pt')['vp'].cpu().detach()[npml:-npml, npml+expand:-npml-expand]
...
# ax.legend()
# plt.tight_layout()
# plt.savefig("figures/ModelError.png",dpi=300, bbox_inches='tight')
