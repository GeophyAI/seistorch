...
inverted = np.load(f'./results/{loss}/paravpF00E00.npy')[npml:-npml, npml+expand:-npml-expand]
grad = np.load(f'./results/{loss}/gradvpF00E00.npy')[npml:-npml, npml+expand:-npml-expand]
...
axes.set_title(f"{loss} Gradient")
plt.tight_layout()
