...
inverted = np.load('./results/towed/paravpF00E10.npy')[npml:-npml, npml+expand:-npml-expand]
grad = np.load('./results/towed/gradvpF00E10.npy')[npml:-npml, npml+expand:-npml-expand]
