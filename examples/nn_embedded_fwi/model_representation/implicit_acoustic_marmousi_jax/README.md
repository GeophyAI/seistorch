...
Since the neural network is initialized with random weights, the inverted model at the 0th iteration is just a random noise with a mean value of `mean_vp` and a standard deviation of `std_vp`.

The inverted velocity model at the 3000th iteration is shown below:

![Inverted velocity model at 3000th iteration](_figures_/invtered02000.png)
