...
pmln = 50
expand = 50
true = np.load("../models/bp2.5d1997/model.npy")#[:,expand:-expand]
init = np.load("../models/bp2.5d1997/vsmooth.npy")#[:,expand:-expand]

grad3d_true = np.load('results/rtm_true/grad3d.npy')
grad3d_true = grad3d_true[:,:, 50:-50, 50:-50].squeeze()

grad3d_init = np.load('results/rtm_true/grad3d.npy')
grad3d_init= grad3d_init[:,:, 50:-50, 50:-50].squeeze()
