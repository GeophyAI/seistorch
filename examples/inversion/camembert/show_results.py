...
inverted = np.load(f'./results_{loss}/paravpF00E{epoch:02d}.npy')[npml:-npml, npml:-npml]
grad = np.load(f'./results_{loss}/gradvpF00E{epoch:02d}.npy')[npml:-npml, npml:-npml]
