...
inverted = np.load(f'./results_full/paravpF{F:02d}E{E:02d}.npy')[npml:-npml, npml+expand:-npml-expand]
grad = np.load(f'./results_full/gradvpF{F:02d}E{E:02d}.npy')[npml:-npml, npml+expand:-npml-expand]
