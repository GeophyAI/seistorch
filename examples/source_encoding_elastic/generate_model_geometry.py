...
vp = np.load("../marmousi_model/true_vp.npy")
vs = np.load("../marmousi_model/true_vs.npy")
rho = np.load("../marmousi_model/rho.npy")

initvp = np.load("../marmousi_model/linear_vp.npy")
initvs = np.load("../marmousi_model/linear_vs.npy")
