...
inverted_l2 =torch.load('./results/l2/model_25.pt', 'cpu')['vp'][npml:-npml, npml+expand:-npml-expand]
inverted_tt = torch.load('./results/traveltime/model_25.pt', 'cpu')['vp'][npml:-npml, npml+expand:-npml-expand]
